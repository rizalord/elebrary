Public Class ClassesPage
    ...
    Private Sub ClassesPage_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        RetrieveWithReset()
    End Sub
    ...
    Private Sub RetrieveData(Optional keyword As String = "")
        ...
        Dim data As ClassResponse = ClassController.index(page, perPage, keyword)
        isNext = data.isNext

        data.data.ForEach(Sub(e)

                              Dim c As ClassCard = New ClassCard(e, AddressOf RetrieveWithReset)
